...
class Cart extends Component {
  ...
  removeFromCart = (product) => {
    this
      .props
      .dispatch({type: 'REMOVE_FROM_CART_REQUEST', payload: product})
  }
              ...
              <Card
                ...
                <Card.Content extra>
                  <Button
                    ...
                    onClick={this
                    .removeFromCart
                    .bind(this, product)}>Remove from Cart</Button>
                </Card.Content>
              </Card>
            ))
}
          ...
          {this.props.username
            ...
            : <Card fluid>
              ...
              <h3
                ...
                padding: 20,
                textAlign: 'center'
              }}>You must be logged in to checkout!</h3>
            </Card>
}
        </div>
      </div>
...
const mapStateToProps = state => ({cart: state.cart.cart, username: state.client.username})
